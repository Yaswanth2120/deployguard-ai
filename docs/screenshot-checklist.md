...
| 12 | **Successful validation output** | Terminal | Capture a passing `./scripts/validate-demo.sh` run. See [e2e-demo-validation.md](e2e-demo-validation.md). |
...
- When you embed these in docs after capturing them, reference them with relative paths such as `assets/01-dashboard-overview.png`.
